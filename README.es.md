...
La guía también incluye un asistente interactivo de configuración. Instala los
paquetes del sistema y Node.js 20+, configura el punto de acceso, guarda la
carpeta de medios, instala el servicio y crea el inicio automático de Chromium
en modo kiosco:
